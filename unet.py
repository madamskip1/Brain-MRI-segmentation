...
class UNet(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.conv_block_l_1 = self.__conv_block(1, 64, 3)
        self.conv_block_l_2 = self.__conv_block(64, 128, 3)
        self.conv_block_l_3 = self.__conv_block(128, 256, 3)
        self.conv_block_l_4 = self.__conv_block(256, 512, 3)

        self.conv_block_mid = self.__conv_block(512, 1024, 3)

        self.conv_block_r_4 = self.__conv_block(1024, 512, 3)
        self.conv_block_r_3 = self.__conv_block(512, 256, 3)
        self.conv_block_r_2 = self.__conv_block(256, 128, 3)
        self.conv_block_r_1 = self.__conv_block(128, 64, 3)
    ...
    def __conv_block(self, in_channels, out_channels, kernel_size = 3):
